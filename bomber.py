...
if len(sys.argv) < 2:
    ...
    '\n' + '\tG-mail bomber by {}Idk'.format(YELLOW, RED, YELLOW, BLUE).center(76) +
...
try:
    ...
    while i < count:
        ...
        if i == 1:
            print (LightCyan+'[✓] '+YELLOW+' %dst Email has been sent ' %(i))
        elif i == 2:
            print (LightCyan+'[✓] '+YELLOW+' %dnd Email has been sent ' %(i))
        elif i == 3:
            print (LightCyan+'[✓] '+YELLOW+' %drd Email has been sent ' %(i))
        else:
            print (LightCyan+'[✓] '+YELLOW+' %dth Email has been sent ' %(i))
        sys.stdout.flush()
    server.quit()
